...
cursor.execute('DELETE FROM predictions')  # 同时清空预测

match_time = datetime(2026, 6, 11, 20, 0)  # 揭幕战：2026年6月11日 20:00
matches = []

# ========== 小组赛 (72场) ==========
# 12个小组 (A-L)，每组4队，每队与其他3队各赛1场 = 每组6场
# 12 × 6 = 72场
